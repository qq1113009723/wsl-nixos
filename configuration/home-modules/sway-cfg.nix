...
# 剪贴板同步
exec_always wsl-clipboard-sync

# 壁纸
output * {
   # bg ~/wsl-sway/background/sway-end.png fill
}

# 显示器布局
# output WL-1 resolution 1920x1080 position 0 0
...
bindsym $mod+Shift+Backspace exec swaylock -f -c $bg
...
# bindsym $mod+h focus prev sibling
# bindsym $mod+l focus next sibling
# --- Workspaces (1-10) ---
...
bar {
    ...
    status_command while date +'%m-%d %R'; do sleep 1; done
